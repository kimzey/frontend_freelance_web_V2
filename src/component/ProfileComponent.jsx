...
export default function ProfileComponent() {
  ...
  const fetchuser = async () =>{
      if(selectUser !== false && User == ""){
          await axios.get(`${import.meta.env.VITE_REACT_APP_API}api/user/${selectUser}`)
          .then((response) => {
    ...
    <>
      ...
      <div className="Profile">
        ...
        <div className="Profilecontainer">
          ...
          <div id="browsePic">
            <div id="displayPic">
              <img src={`${import.meta.env.VITE_REACT_APP_API}img_user/${User.name_img||"avatar.png"}`} id="profile_img" ></img>
            </div>
          </div>
       ...
       {User.name_pdf && (
          <div className="Profilecontainer">
            ...
            <iframe src={`${import.meta.env.VITE_REACT_APP_API}pdf_user/${User.name_pdf}`} id="showport">  </iframe>
          </div>
       )}
